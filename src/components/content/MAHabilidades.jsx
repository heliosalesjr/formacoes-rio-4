      ...
      <div className="text-center space-y-6">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="text-4xl font-bold text-center leading-tight">
            <span className="text-slate-800">Habilidades Desenvolvidas</span><br />
            ...
            <span className="text-slate-800"> e Relação</span><br />
            <span className="text-slate-800">com a </span>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {/* Reflexão crítica */}
            <div className="bg-white rounded-lg p-5 shadow-lg border border-blue-100 hover:shadow-xl transition-shadow duration-300">
        ...
        {/* Coluna Vida Profissional */}
        <div className="space-y-6">
          <div className="bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-6 py-3 rounded-lg shadow-lg">
            <h2 className="text-xl font-bold text-center">Vida Profissional</h2>
          </div>
          
          <div className="space-y-4">
            {/* Identificar pontos */}
            <div className="bg-white rounded-lg p-5 shadow-lg border border-cyan-100 hover:shadow-xl transition-shadow duration-300">
              <div className="flex items-start gap-4">
